...
<div class="sidenav">
    ...
    <a href="Sales_Performance.php">Sales Performance</a>
...
WHERE p.fk_regid = $userid order by o.order_date desc;
 ";
...
<p>Order Placed: <?php echo date("F j, Y h:i A", strtotime($row['order_date'])); ?></p>
<?php
