...
<body>
  ...
  <div  id="user-details" class="profile-details">
        ...
        <table>
            ...
            <?php
            $sql = "SELECT * FROM tbl_registration r, tbl_login l WHERE r.fk_loginid=l.login_id AND user_roles='1' AND l.status='1' ";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (isset($_POST["lf"]) && $_POST['lf']=="blocked") {
                    ...
                    $sql = "SELECT * FROM tbl_registration r, tbl_login l WHERE r.fk_loginid=l.login_id AND l.user_roles='1' and l.status='0'";
    ...
    <div class="custom-modal-content">
        ...
        <form method="post" action="#">
            ...
            <select id="reasonSelect" onchange="populateTextarea()">
                ...
                <option value="consumerSafety">Consumer Safety</option>
            </select>
...
document.querySelector('.sidebar a[href="Manage_staff.php"]').addEventListener('click', function(event) {
    ...
    switch (selectedReason) {
        case "qualityAssurance":
            memoTextarea.value = "Dear Seller,\n\nWe would like to inform you about recent quality assurance concerns regarding your food product. Please take immediate action to address these issues. Thank you.\n\nSincerely,\nHomley";
            break;
        case "regulatoryCompliance":
            memoTextarea.value = "Dear Seller,\n\nIt has come to our attention that there are regulatory compliance issues with your food product. Please ensure all necessary measures are taken to rectify these issues promptly. Thank you.\n\nSincerely,\nHomley";
            break;
        case "consumerSafety":
            memoTextarea.value = "Dear Seller,\n\nOur recent safety inspections have identified concerns regarding the safety protocols associated with your food product. Please prioritize the safety of our consumers and take immediate action to address these concerns. Thank you.\n\nSincerely,\nHomley";
            break;
        default:
            memoTextarea.value = ""; // Clear textarea if no reason selected
            break;
    }
}
