  ...
  <div class="items-container">
    ...
    if (isset($_POST['filter'])) {
      ...
      elseif (isset($_POST['price-sort'])) {
        ...
        p.p_status = '1' AND p.stock > 0  and tc.category_id = 2
       ";
      ...
      tbl_products p
                   JOIN 
                   tbl_categories tc ON tc.category_id = p.category_id where tc.category_id = 2  and p.p_status = '1' AND p.stock > 0 
     ORDER BY 
     p.product_id DESC;
     ";
    }
